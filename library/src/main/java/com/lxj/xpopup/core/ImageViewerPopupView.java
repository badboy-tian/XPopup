...
//        pager.setOffscreenPageLimit(urls.size());
    ...
    public ImageViewerPopupView setOnSaveBtnClickListener(OnSaveBtnClickListener onSaveBtnClickListener) {
            ...
            XPermission.create(getContext(), PermissionConstants.STORAGE)
                    .callback(new XPermission.SimpleCallback() {
                        ...
                        public void onGranted() {
                            ...
                            XPopupUtils.saveBmpToAlbum(getContext(), imageLoader, urls.get(position), onSaveBtnClickListener, position);
                        }
                        @Override
                        public void onDenied() {
                            if (onSaveBtnClickListener != null){
                                onSaveBtnClickListener.onSaveButtonClicked(position, false);
                            }
